...
export default function Home() {
  return (
    <Layout showFooter>
      ...
      <p className="text-xs font-thin">Last updated: December 01, 2024</p>
      ...
      <h2 className="mt-4 text-xl font-bold">Interpretation and Definitions</h2>
      <h3 className="text-lg font-semibold">Interpretation</h3>
      <p className="">
        The words of which the initial letter is capitalized have meanings defined under the following conditions. The
        following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
      </p>
      <h3 className="mt-2 text-lg font-semibold">Definitions</h3>
      ...
      <ul className="ml-4 list-disc">
        ...
        <li>
          <p className="">
            ...
            &quot;Our&quot; in this Agreement) refers to Big Movie bois.
          </p>
        </li>
        <li>
          <p className="">
        ...
        <li>
          <p className="">
            <strong>Website</strong> refers to Big Movie bois, accessible from{" "}
            <a href="https://www.bigmoviebois.com" rel="external nofollow noopener" target="_blank">
              https://www.bigmoviebois.com
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="mt-4 text-xl font-bold">Collecting and Using Your Personal Data</h2>
      <h3 className="text-lg font-semibold">Types of Data Collected</h3>
      <h4 className="text-lg underline">Personal Data</h4>
      <p className="">
      ...
      <ul className="ml-4 list-disc">
        ...
        <li>
          <p className="">First name and last name</p>
        </li>
        <li>
          <p className="">Usage Data</p>
        </li>
      </ul>
      <h4 className="text-lg underline">Usage Data</h4>
      <p className="">Usage Data is collected automatically when using the Service.</p>
      <p className="">
      ...
      <h4 className="text-lg underline">Tracking Technologies and Cookies</h4>
      <p className="">
      ...
      <p className="">We use both Session and Persistent Cookies for the purposes set out below:</p>
      <ul className="ml-4 list-disc">
        <li>
          <p className="">
            <strong>Necessary / Essential Cookies</strong>
          </p>
          <p className="">Type: Session Cookies</p>
        ...
        <li>
          ...
          <p className="">Type: Persistent Cookies</p>
          <p className="">Administered by: Us</p>
          <p className="">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
        </li>
        <li>
          <p className="">
      ...
      <h3 className="mt-2 text-lg font-semibold">Use of Your Personal Data</h3>
      <p className="">The Company may use Personal Data for the following purposes:</p>
      <ul className="ml-4 list-disc">
        <li>
          <p className="">
      ...
      <p className="">We may share Your personal information in the following situations:</p>
      <ul className="ml-4 list-disc">
        <li>
      ...
      <h3 className="mt-2 text-lg font-semibold">Retention of Your Personal Data</h3>
      <p className="">
      ...
      <h3 className="mt-2 text-lg font-semibold">Transfer of Your Personal Data</h3>
      <p className="">
      ...
      <h3 className="mt-2 text-lg font-semibold">Delete Your Personal Data</h3>
      <p className="">
      ...
      <h3 className="mt-2 text-lg font-semibold">Disclosure of Your Personal Data</h3>
      <h4 className="text-lg underline">Business Transactions</h4>
      <p className="">
      ...
      <h4 className="text-lg underline">Law enforcement</h4>
      <p className="">
      ...
      <h4 className="text-lg underline">Other legal requirements</h4>
      <p className="">
      ...
      <h3 className="mt-2 text-lg font-semibold">Security of Your Personal Data</h3>
      <p className="">
      ...
      <h2 className="mt-4 text-xl font-bold">Children's Privacy</h2>
      <p className="">
      ...
      <h2 className="mt-4 text-xl font-bold">Links to Other Websites</h2>
      <p className="">
      ...
      <h2 className="mt-4 text-xl font-bold">Changes to this Privacy Policy</h2>
      <p className="">
      ...
      <p className="">If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul className="ml-4 list-disc">
        <li>
          By visiting this page on our website:{" "}
          <a href="https://www.bigmoviebois.com/contact" rel="external nofollow noopener" target="_blank">
            https://www.bigmoviebois.com/contact
          </a>
        </li>
      </ul>
    </Layout>
